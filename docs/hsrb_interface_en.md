...
Below are some example commands. For more details, please check the help for each function.
...
omni_base.follow_trajectory([geometry.pose(x=1.0, y=0.0, ek=0.0), geometry.pose(x=1.0, y=1.0, ek=math.pi)], time_from_starts=[10, 30], ref_frame_id='base_footprint')
omni_base.create_follow_trajectory_goal(poses, time_from_starts=[10, 30], ref_frame_id='base_footprint')
