...
git clone -b feature/joint-command-controller-and-limiter https://github.com/hsr-project/hsrb_common.git
git clone -b humble https://github.com/hsr-project/hsrb_drivers.git
git clone -b feature/joint-command-controller-and-limiter https://github.com/hsr-project/hsrb_launch.git
...
git clone -b feature/joint-command-controller-and-limiter https://github.com/hsr-project/hsrb_simulator.git
...
git clone -b feature/joint-command-controller-and-limiter https://github.com/hsr-project/tmc_common.git
...
git clone -b feature/joint-command-controller-and-limiter https://github.com/hsr-project/tmc_realtime_control.git
